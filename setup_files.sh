...
echo "Ì∫Ä Setting up Gate Pass Flutter App..."
...
echo "Ì≥ù Now copy the content from each artifact into the corresponding files."
echo "ÌæØ Don't forget to replace pubspec.yaml and AndroidManifest.xml content!"
